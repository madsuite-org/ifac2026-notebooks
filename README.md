...
| `reductions-solution.ipynb` | Worked solution to the interior-point reductions exercise |
| `montecarlo-pi-solution.ipynb` | Worked solution to the Monte-Carlo π exercise |
